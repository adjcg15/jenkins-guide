    ...
    stage('Deploy') {
      ...
      steps {
        script {
          ...
          sshCommand (remote: remote, command:"cd C:\\deploy\\todolist ; curl -L -o docker-compose.yml https://raw.githubusercontent.com/adjcg15/jenkins-guide/deployment-pipeline/Jenkins-Guide_To-Do-List/docker-compose.yml")
            sleep 15 
        }
